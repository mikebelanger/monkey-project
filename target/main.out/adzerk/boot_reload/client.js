...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11131,opts){
var map__11132 = p__11131;
var map__11132__$1 = ((((!((map__11132 == null)))?((((map__11132.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11132.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11132):map__11132);
var files = cljs.core.get.call(null,map__11132__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8426__auto___11140 = arguments.length;
var i__8427__auto___11141 = (0);
while(true){
if((i__8427__auto___11141 < len__8426__auto___11140)){
args__8433__auto__.push((arguments[i__8427__auto___11141]));

var G__11142 = (i__8427__auto___11141 + (1));
i__8427__auto___11141 = G__11142;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11136){
var vec__11137 = p__11136;
var opts = cljs.core.nth.call(null,vec__11137,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11137,opts){
return (function (evt){
...
});})(conn,vec__11137,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11137,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11137,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11137,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11134){
var G__11135 = cljs.core.first.call(null,seq11134);
var seq11134__$1 = cljs.core.next.call(null,seq11134);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11135,seq11134__$1);
});
