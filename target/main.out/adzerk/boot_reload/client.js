...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11114,opts){
var map__11115 = p__11114;
var map__11115__$1 = ((((!((map__11115 == null)))?((((map__11115.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11115.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11115):map__11115);
var files = cljs.core.get.call(null,map__11115__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8426__auto___11123 = arguments.length;
var i__8427__auto___11124 = (0);
while(true){
if((i__8427__auto___11124 < len__8426__auto___11123)){
args__8433__auto__.push((arguments[i__8427__auto___11124]));

var G__11125 = (i__8427__auto___11124 + (1));
i__8427__auto___11124 = G__11125;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11119){
var vec__11120 = p__11119;
var opts = cljs.core.nth.call(null,vec__11120,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11120,opts){
return (function (evt){
...
});})(conn,vec__11120,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11120,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11120,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11120,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11117){
var G__11118 = cljs.core.first.call(null,seq11117);
var seq11117__$1 = cljs.core.next.call(null,seq11117);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11118,seq11117__$1);
});
