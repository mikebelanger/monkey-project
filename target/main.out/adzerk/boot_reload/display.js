...
return (function (p__8766){
var vec__8767 = p__8766;
var attr = cljs.core.nth.call(null,vec__8767,(0),null);
...
var args8770 = [];
var len__8426__auto___8773 = arguments.length;
var i__8427__auto___8774 = (0);
while(true){
if((i__8427__auto___8774 < len__8426__auto___8773)){
args8770.push((arguments[i__8427__auto___8774]));

var G__8775 = (i__8427__auto___8774 + (1));
i__8427__auto___8774 = G__8775;
continue;
} else {
}
break;
...
var len__8426__auto___8778 = arguments.length;
var i__8427__auto___8779 = (0);
while(true){
if((i__8427__auto___8779 < len__8426__auto___8778)){
args__8433__auto__.push((arguments[i__8427__auto___8779]));

var G__8780 = (i__8427__auto___8779 + (1));
i__8427__auto___8779 = G__8780;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8777){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8777));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8781){
var map__8785 = p__8781;
...
var G__8787 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8787,goog.events.EventType.CLICK,((function (G__8787,map__8785,map__8785__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8787,map__8785,map__8785__$1,data,message,line,file))
);

return G__8787;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8788){
var map__8792 = p__8788;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8795){
var map__8799 = p__8795;
var map__8799__$1 = ((((!((map__8799 == null)))?((((map__8799.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8799.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8799):map__8799);
var messages = map__8799__$1;
var warnings = cljs.core.get.call(null,map__8799__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8799__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8801 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8801,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8801,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8802){
var map__8805 = p__8802;
...
var messages = map__8805__$1;
var warnings = cljs.core.get.call(null,map__8805__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8805__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8805,map__8805__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8805,map__8805__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8805,map__8805__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8805,map__8805__$1,messages,warnings,exception))
;
...
}catch (e8808){if((e8808 instanceof Error)){
var __8809 = e8808;
} else {
throw e8808;
