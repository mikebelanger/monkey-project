...
var attr = cljs.core.nth.call(null,vec__13353,(0),null);
var v = cljs.core.nth.call(null,vec__13353,(1),null);
...
var args13356 = [];
var len__8426__auto___13359 = arguments.length;
var i__8427__auto___13360 = (0);
while(true){
if((i__8427__auto___13360 < len__8426__auto___13359)){
args13356.push((arguments[i__8427__auto___13360]));

var G__13361 = (i__8427__auto___13360 + (1));
i__8427__auto___13360 = G__13361;
continue;
} else {
}
break;
...
var len__8426__auto___13364 = arguments.length;
var i__8427__auto___13365 = (0);
while(true){
if((i__8427__auto___13365 < len__8426__auto___13364)){
args__8433__auto__.push((arguments[i__8427__auto___13365]));

var G__13366 = (i__8427__auto___13365 + (1));
i__8427__auto___13365 = G__13366;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq13363){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13363));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__13367){
var map__13371 = p__13367;
var map__13371__$1 = ((((!((map__13371 == null)))?((((map__13371.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13371.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13371):map__13371);
var data = map__13371__$1;
var message = cljs.core.get.call(null,map__13371__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__13371__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__13371__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__13373 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__13373,goog.events.EventType.CLICK,((function (G__13373,map__13371,map__13371__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__13373,map__13371,map__13371__$1,data,message,line,file))
);

return G__13373;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__13374){
var map__13378 = p__13374;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__13381){
...
var messages = map__13385__$1;
var warnings = cljs.core.get.call(null,map__13385__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13385__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
goog.dom.append(G__13387,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__13387,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__13388){
...
var messages = map__13391__$1;
var warnings = cljs.core.get.call(null,map__13391__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13391__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__13391,map__13391__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__13391,map__13391__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__13391,map__13391__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__13391,map__13391__$1,messages,warnings,exception))
;
